...
[database]
connection = mysql+pymysql://keystone:openstack@controller001/keystone
...
sudo keystone-manage bootstrap --bootstrap-password openstack \
  --bootstrap-admin-url http://controller001:5000/v3/ \
  --bootstrap-internal-url http://controller001:5000/v3/ \
  --bootstrap-public-url http://controller001:5000/v3/ \
...
$ openstack project create --domain default \
  --description "Service Proje ct" service
